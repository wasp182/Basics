...
exits = {0: {"Q": 0},
         ...
         5: {"W": 2, "S": 1, "Q": 0}}
print("*"*80)
print("exits to a given location using loops")
...
print("*"*80)
print("exits to a given location using comprehension in loop")
...
"""
print("*"*80)
print("exits to a given location using nested comprehension ")
...
for i in range(1000,10000,1000):
    res_1 = timeit.timeit(loop_code,number=i,setup=setups)
    res_2 = timeit.timeit(comp_code,number=i,setup=setups)
    res_3 = timeit.timeit(nested_comp_code,number=i,setup=setups)
