...
with open(output_filename,'w',encoding="utf-8",newline="") as op_stream:
    writer_obj = csv.writer(op_stream,quoting= csv.QUOTE_NONNUMERIC)
    # takes op stream and converts to csv object with dialect specifications
    writer_obj.writerow(column_headings)
    writer_obj.writerows(cereals)
